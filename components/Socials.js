...
const Socials = () => {
  ...
  <Link target="_blank"  href={"https://leetcode.com/kanyakrishi/"} className='hover:text-accent  transition-all duration-300'><Image src={'./leetcode.svg'} width={18} height={18} alt='leetcode icon'/></Link>
