        ...
        {navData.map((link, index) => {
          return (
            <Link
              ...
              } relative flex items-center hover:text-accent group transition-all duration-300`}
              href={link.path}
              key={index}
            >
              {/* create a tooltip on hover */}
              <div className="absolute pr-14 hidden right-0 xl:group-hover:flex">
                <div className="bg-white text-primary items-center p-[6px] relative flex rounded-lg font-semibold capitalize ">
